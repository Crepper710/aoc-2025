...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `35.1µs` | `210.7µs` |
| [Day 2](./src/bin/02.rs) | `7.2ms` | `34.7ms` |
| [Day 3](./src/bin/03.rs) | `39.7µs` | `50.3µs` |
| [Day 4](./src/bin/04.rs) | `141.5µs` | `1.7ms` |
| [Day 5](./src/bin/05.rs) | `51.5µs` | `24.8µs` |
| [Day 6](./src/bin/06.rs) | `43.8µs` | `177.7µs` |
| [Day 7](./src/bin/07.rs) | `64.4µs` | `30.6µs` |
| [Day 8](./src/bin/08.rs) | `28.2ms` | `28.4ms` |
| [Day 9](./src/bin/09.rs) | `902.1µs` | `10.7ms` |
| [Day 10](./src/bin/10.rs) | `1.4ms` | `120.4ms` |
| [Day 11](./src/bin/11.rs) | `407.6µs` | `1.6s` |
| [Day 12](./src/bin/12.rs) | `89.7µs` | `-` |
